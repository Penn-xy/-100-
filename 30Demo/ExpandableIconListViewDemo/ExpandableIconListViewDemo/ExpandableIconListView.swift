...
class ExpandableIconListView: UIView {
    ...
    /**
     ...
     - returns: an ExpandableIconListView
     */
    public init(frame: CGRect, images:[UIImage]) {
        ...
        let onTapView = UITapGestureRecognizer(target: self, action: #selector(ExpandableIconListView.onViewTapped))
